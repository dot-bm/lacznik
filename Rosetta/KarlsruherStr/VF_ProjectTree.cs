...
{
    public class VF_ProjectTree
    {
        private string __root;

        //private List<Tuple<string, string, string>> __visPfdDef;

        //public string Root { get { return __root; } }

        //private void __FillPfdDef()
        //{
        ...
        //    __visPfdDef.Add(new Tuple<string, string, string>("Scenario management project", "vpdb;vpdbx", "Szenariomanagement-Projekt")); 
        ...
        //    __visPfdDef.Add(new Tuple<string, string, string>("Access 2007 database", "accdb", "Access-2007-Datenbank")); 
        ...
        //    __visPfdDef.Add(new Tuple<string, string, string>("Procedure parameters", "par;xml", "Verfahrensparameter")); 
        ...
        //    __visPfdDef.Add(new Tuple<string, string, string>("Background", "emf;wmf;bmp;dwg;dxf;ecw;jp2;jpg;png;shp;sid;svg;tga;tif;gif", "Hintergruende")); 
        ...
        //    __visPfdDef.Add(new Tuple<string, string, string>("Screenshot", "jpg;wmf;emf;bmp;gif;tiff;png", "Screenshots")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Exported turn volumes", "jpg;png;gif;wmf;emf;bmp;tiff;svg", "Exportierte Knotenströme")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Legend parameters", "lgd", "Legenden-Parameter")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Timetable graphic parameters", "gpt;gpbe;gpgt;gptt", "Fahrplan-Grafikparameter")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Matrix editor graphic parameters", "gpm", "Grafikparameter Matrixeditor")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Schematic line diagram graphic parameters", "gpsld", "Grafikparameter Schematischer Liniennetzplan")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Transfers display of regular services - graphic parameters", "gpta", "Grafikparameter Umsteiger-Taktdarstellung")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Timetable layout", "tly;tlbe;tltt;tlls;tlbs", "Fahrplan-Layout")); 
        ...
        //    __visPfdDef.Add(new Tuple<string, string, string>("PuT interfaces project", "putp;puti;haf", "ÖV-Schnittstellen-Parameterdateien")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("TModel project", "tla", "TModel-Dateien")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Network merge parameters", "nmp", "Netzvereinigungs-Para")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Parameters for Read network additively", "anrp", "Additives-Netzlesen-Para")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Parameters for Read demand additively", "adrp", "Additives-Nachfragelesen-Para")); 
        //    __visPfdDef.Add(new Tuple<string, string, string>("Parameters for matrix operations", "xml;cod", "Parameter für Matrixoperationen")); 
        ...
        public VF_ProjectTree(string root)
        {
            //__FillPfdDef();
            __root = root;
            //var loc = new Config();
            var t = _.I.Cfg.Root;
            //loc.Entry = new Config.Inx1(loc);
        }

        public string PFDFileName => _.I.Cfg.Root + "\\" + VF_PfdHelper.PfdEntryByExt("pfd") + "\\directories.pfd";

        public string VerDirName => _.I.Cfg.Root + "\\" + VF_PfdHelper.PfdEntryByExt("ver");

        public void createDir()
        {
            var y = VF_PfdHelper.EnumValues().Select(tup =>
            {
                //bool b = false;
                string s = null;
                try
                {
                    s = _.I.Cfg.Root + "\\" + tup.Item1;
                ...
                return new[] {tup.Item3, "\"" + s + "\"", tup.Item2};
            }).Where(r => !string.IsNullOrEmpty(r[1])).Select(t => string.Join(" ", t)).ToList();
            using (var fs = new FileStream(PFDFileName, FileMode.OpenOrCreate))
            {
                var sw = new StreamWriter(fs);
                foreach (var n in y) sw.WriteLine(n);
                sw.Flush();
            }
        }
    }
