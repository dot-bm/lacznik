...
using Rosetta.Model.OttoDixRing;
...
namespace Rosetta.Model
{
    ...
    {
        private readonly BlaCommonStorage __parent;
        ...
        public MckStops Stops { get; }
        public PosLinien Lines { get; }
        public OdxBetrieberListe Operators { get; }
    }
}