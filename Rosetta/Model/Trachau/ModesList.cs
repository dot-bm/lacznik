...
{
    public class ModesList : KarlsruheList<Mode>, IKarlsruheReadyCollection
    {
        public override string HeaderCore => "MODE:CODE;NAME;TSYSSET";
        ...
        protected override int _keyExtractor(Mode item)
        {
