...
{
    public class Rck_LnC_LinkCouplingCollector : Rck_Generic, IReickQuelle
    {
        public override bool Prepare()
        {
            ...
            try
            {
                _platform.Graph.Links.AddLinks(_platform.EntityReader[203].Query(_cpool, _platform.Variant)
                    .Select(y => new KdzCouplingLink(y, _platform.Graph.Nodes, _platform.DemFoundation.TSysList)));
            }
            catch (Exception e)
            {
