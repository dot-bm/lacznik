...
{
    internal class Pha_60_Lines : Pha_GA_GenericAutomated
    {
        public Pha_60_Lines() : base(90)
        {
        }

        protected override string _HEader_ConstString => "LINE:Name;TSysCode";
        ...
        {
            return _phs.PuT.Lines.Select(l => new Tuple<int, int?>(l.ObjectId, null));
        }

        protected override IEnumerable<BlaBinResultRow> _OwnObj_AsString()
        {
            return _phs.PuT.Lines.Select((l, i) => new BlaBinResultRow
                {Content = l.Core(), EntityID = EntityID, OrdNum = i, RelObjID = null});
        }
    }
}